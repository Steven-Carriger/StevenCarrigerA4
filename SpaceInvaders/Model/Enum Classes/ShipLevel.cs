...
{
    /// <summary> the levels for each ship, the higher the level the more challenging to fight. </summary>
    public enum ShipLevel
    {
        /// <summary> level one, the most basic level for the enemy ship </summary>
        LevelOne,
